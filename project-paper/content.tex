...
System'' in early 2008~\cite{hid-sp18-414-www-blockchain-theory-application}.  The
concepts that were outlined from Satwik Kansal at IBM was the guidelines that
were followed to build this simple blockchain example~\cite{hid-sp18-414-www-blockchain-example}. 
